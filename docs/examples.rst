...
* Simple example how to read a TIME_SERIES curve
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Timeseries_curve_examples/ts_simple_read.py>`_ ,
  :download:`[download] <../examples/Timeseries_curve_examples/ts_simple_read.py>`)
* Aggregation example
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Timeseries_curve_examples/ts_aggregation.py>`_ ,
  :download:`[download] <../examples/Timeseries_curve_examples/ts_aggregation.py>`)
* Aggregation example - changing timezones
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Timeseries_curve_examples/ts_aggregation_timezone.py>`_ ,
  :download:`[download] <../examples/Timeseries_curve_examples/ts_aggregation_timezone.py>`)
* Filter example
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Timeseries_curve_examples/ts_filter.py>`_ ,
  :download:`[download] <../examples/Timeseries_curve_examples/ts_filter.py>`)
* Read multiple curves and save them as csv
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Timeseries_curve_examples/ts_get_multiple_curves.py>`_ ,
...
* Simple example how to read an INSTANCE curve
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Instance_curve_examples/ins_simple_read.py>`_ ,
  :download:`[download] <../examples/Instance_curve_examples/ins_simple_read.py>`)
* Get multiple instances
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Instance_curve_examples/ins_multiple_instances.py>`_ ,
  :download:`[download] <../examples/Instance_curve_examples/ins_multiple_instances.py>`)
* Get multiple instances with custom filter
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Instance_curve_examples/ins_multiple_instances.py>`_ ,
  :download:`[download] <../examples/Instance_curve_examples/ins_custom_filter_multiple_instances.py>`)
* Get latest instance
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Instance_curve_examples/ins_latest_instance.py>`_ ,
...
* Get multiple instance curves and save them as csv
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Instance_curve_examples/ins_get_multiple_curves.py>`_ ,
...
* Simple example on how to get a relative forecast
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Instance_curve_examples/ins_get_relative.py>`_ ,
  :download:`[download] <../examples/Instance_curve_examples/ins_get_relative.py>`)


TAGGED_INSTANCE curve examples
--------------------------------
Also check out examples from the section above on INSTANCE curves, as the
methods for getting instances are the same for both curve types.

* Simple example how to read a TAGGED_INSTANCE curve and get available tags
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Tagged-Instance_curve_examples/tagins_simple_read.py>`_ ,
  :download:`[download] <../examples/Tagged-Instance_curve_examples/tagins_simple_read.py>`)
* Read data for multiple tags
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Tagged-Instance_curve_examples/tagins_multiple_tags.py>`_ ,
  :download:`[download] <../examples/Tagged-Instance_curve_examples/tagins_multiple_tags.py>`)
* Get multiple instances
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Tagged-Instance_curve_examples/tagins_multiple_instances.py>`_ ,
  :download:`[download] <../examples/Tagged-Instance_curve_examples/tagins_multiple_instances.py>`)
* Get latest instance
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Tagged-Instance_curve_examples/tagins_latest_instance.py>`_ ,
...
* Listening for changes for several Solar and Wind curves and append new data to
  ...
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/Listening_for_changes/renewables_database.py>`_ ,
...
* Comparing PV forecast and actuals
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/general_examples/gen_pv_actuals_vs_forecast.py>`_ ,
  :download:`[download] <../examples/general_examples/gen_pv_actuals_vs_forecast.py>`)
* Combining Series to DataFrame in pandas
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/general_examples/gen_series_to_frame.py>`_ ,
  :download:`[download] <../examples/general_examples/gen_series_to_frame.py>`)
* Saving pandas Series and DataFrames to csv and xlsx
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/general_examples/gen_save_pandas.py>`_ ,
  :download:`[download] <../examples/general_examples/gen_save_pandas.py>`)
* Aggregation examples using pandas
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/general_examples/gen_aggregation_pandas.py>`_ ,
...
* Reproduce one of the 4 following Fundamental figures for any region
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/reproduce_wattsight_plots/ws_fundamentals_hourly.py>`_ ,
...
* Reproduce temperature figures for any region
  (`[view on github] <https://github.com/volue-public/volue-insight-timeseries/blob/main/examples/reproduce_wattsight_plots/ws_temperature_hourly.py>`_ ,
